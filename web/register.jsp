<%-- 
    Document   : register
    Created on : Dec 1, 2017, 2:16:44 PM
    Author     : DLK 1
--%>
        ...
        <div class="row">
          <div class="leftbar_content">
            ...
            <div class="single_stuff wow fadeInDown">
              <form action="reg">
                    <center>
                        <h1 style="color:#0b333f;">New User SignUp</h1>
                        <strong>Username : &emsp;</strong>
                        <input type="text" name="name" required=""/><br><br>
                        <strong> Password: &emsp;&nbsp;&nbsp;</strong>
                        <input type="password" name="pass" required=""/><br><br>
                        <strong>Gender : &nbsp;&emsp;&emsp;</strong>
                        <select name="gender" style="width:175px;height:25px;">
                            <option>Male</option>
                            <option>Female</option>
                        </select><br><br>
                        <strong> Mobile No: &emsp;</strong>
                        <input type="text" name="mobile" required=""/><br><br>
                        <strong> Email Id: &nbsp;&emsp;&nbsp;&nbsp;</strong>
