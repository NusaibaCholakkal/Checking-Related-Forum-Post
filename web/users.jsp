<%-- 
    Document   : users
    Created on : Dec 1, 2017, 3:44:50 PM
    Author     : DLK 1
--%>
  ...
  <table id="pro_display_table" border="0" cellspacing="1px"  style="border: 4px solid #FB9217; width:auto; height: auto;">
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
                                   ...
                                   <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Mobile</strong></b></td>
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Location&emsp;</strong></b></td>
...
<% 
                        ...
                        String Query22="select * from user_reg ";
                        ...
                        ResultSet rs22=ps22.executeQuery();
                                      while(rs22.next())
                                      {
                                          ...
                                          %>
                                <tr>                                  
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;<%=rs22.getString("name")%></td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&emsp;&emsp;<%=rs22.getString("email")%>&nbsp;&nbsp;</td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&emsp;&nbsp;<%=rs22.getString("phonenumber")%>&nbsp;&nbsp;</td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&emsp;&nbsp;<%=rs22.getString("address")%>&nbsp;&nbsp;</td>
