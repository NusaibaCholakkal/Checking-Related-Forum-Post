<%-- 
    Document   : addforum
    Created on : Dec 1, 2017, 5:18:49 PM
    Author     : DLK 1
--%>
    ...
    <div class="row">
        ...
        <div class="row">
          <div class="leftbar_content">
            <h2 style="color: white;">Post Forum</h2>
            <div class="single_stuff wow fadeInDown">
              <form action="forum" enctype="multipart/form-data" method="post">
                    <center>
                        <h1 style="color:#0b333f;">Add New Forum</h1><br>
                        <strong>Forum Name : &emsp;</strong>
                        <input type="text" name="fname" required=""/><br><br>
                        <input type="hidden" name="uname" value="<%=name%>" required=""/>
                        <strong>Category: &nbsp;&nbsp;&emsp;&emsp;</strong>
                        <select name="cate" style="width:175px;height:25px;">
                        ...
                        <strong>Upload Image : &emsp;&nbsp;&nbsp;</strong>
                        <input type="file" name="pass" required=""/><br><br>
